...
cluster_host_info = {
    ...
    'app_timeline_server': default('configurations/freeipa/app_timeline_server', '').split(','),
    'nagios_server': default('configurations/freeipa/nagios_server', default("/clusterHostInfo/ambari_server_host", [''])[0]).split(','),
    'falcon_server': default('configurations/freeipa/falcon_server', '').split(','),
    'knox_server': default('configurations/freeipa/knox_server', '').split(','),
    'storm_ui_server': default('configurations/freeipa/storm_ui_server', '').split(','),
    'storm_drpc_server': default('configurations/freeipa/storm_drpc_server', '').split(',')
}
