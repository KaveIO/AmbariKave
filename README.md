...
* To download and install a released version of AmbariKave from the repos server: http://repos.kave.io , e.g. 1.4-Beta, with username repos and password kaverepos
```
yum -y install wget curl tar zip unzip gzip
wget http://repos:kaverepos@repos.kave.io/centos6/AmbariKave/1.4-Beta/ambarikave-installer-centos6-1.4-Beta.sh
sudo bash ambarikave-installer-centos6-1.4-Beta.sh
```
